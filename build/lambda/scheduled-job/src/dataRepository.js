...
exports.getActiveJobsWithScheduleKey = exports.getDueSchedulesTransaction = exports.getDueSchedules = exports.setNextRunDateTimeForNewJobSchedules = void 0;
/** creating some nonsense here to get compiled */
const unmarshall = (something) => {
 ...
 */
const setNextRunDateTimeForNewJobSchedules = async (log, dynamoDB) => {
    var _a;
    try {
        ...
        if (!noNextData || !(noNextData === null || noNextData === void 0 ? void 0 : noNextData.Items) || ((_a = noNextData === null || noNextData === void 0 ? void 0 : noNextData.Items) === null || _a === void 0 ? void 0 : _a.length) === 0) {
            const msg = 'There is not even a single job schedule without a set NextRunDateTime';
            log.info(msg);
            return;
        }
        for await (const dbItem of noNextData === null || noNextData === void 0 ? void 0 : noNextData.Items) {
...
exports.setNextRunDateTimeForNewJobSchedules = setNextRunDateTimeForNewJobSchedules;
/**
 ...
 * @returns Promise<any>
 */
const getDueSchedules = async (utcNow, log, dynamoDB) => {
...
const getDueSchedulesTransaction = async (utcNow, log, dynamoDB) => {
...
exports.getDueSchedulesTransaction = getDueSchedulesTransaction;
/**
 * Get the active Jobs
 * @param scheduleKey String
 * @returns
 */
const getActiveJobsWithScheduleKey = async (scheduleKey, log, dynamoDB /*, nextRunDateTime: any*/) => {
...
exports.getActiveJobsWithScheduleKey = getActiveJobsWithScheduleKey;
